...
import 'package:demo_app/__generated__/serializers.gql.dart' as _i1;
...
abstract class GPeopleData_allPeople
  ...
  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
        GPeopleData_allPeople.serializer,
        this,
      ) as Map<String, dynamic>);
...
abstract class GPeopleData_allPeople_pageInfo
  ...
  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
        GPeopleData_allPeople_pageInfo.serializer,
        this,
      ) as Map<String, dynamic>);
...
abstract class GPeopleData_allPeople_people
  ...
  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
        GPeopleData_allPeople_people.serializer,
        this,
      ) as Map<String, dynamic>);
...
abstract class GPeopleData_allPeople_people_species
  ...
  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
        GPeopleData_allPeople_people_species.serializer,
        this,
      ) as Map<String, dynamic>);
